...
public class AddRoute extends Activity {
    ...
    public String addUrl = "http://practoe.flairinfosystems.in/practoe/addroute.php";
    ...
    public class LineAdding extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(AddRoute.this);
        ...
        protected String doInBackground(String... params) {
            ...
            args.add(new BasicNameValuePair("routename",routenameStr));
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    Intent i=new Intent(AddRoute.this,RouteManagement.class);
                    startActivity(i);
                    // closing this screen
                    finish();
                } else {
