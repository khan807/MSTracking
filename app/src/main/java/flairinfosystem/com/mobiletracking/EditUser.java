...
public class EditUser extends Activity {
    TextInputEditText name_TIL,email_TIL,mobile_TIL;
    Button update_btn;
    String nameString,noString,emailString,getNameString,getNoString,getEmailString;
    ProgressDialog progressDialog;
    JSONParser parser = new JSONParser();
    private static final String TAG_SUCCESS = "success";


    public String addUrl = "http://practoe.flairinfosystems.in/practoe/edituser.php";
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        getEmailString=getIntent().getStringExtra("email");
        email_TIL.setText(getEmailString);
        ...
        update_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if((name_TIL.getText().toString().length())>0 &&
                        (email_TIL.getText().toString().length())>0 &&
    ...
    public class LineAdding extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            emailString=email_TIL.getText().toString();
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    Intent i=new Intent(EditUser.this,UserManagement.class);
                    startActivity(i);
                    // closing this screen
                    finish();
                } else {
