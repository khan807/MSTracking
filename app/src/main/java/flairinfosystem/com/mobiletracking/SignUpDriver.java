...
public class SignUpDriver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mEmailTxt=(EditText)findViewById(R.id.signupemail);
        ...
        fireData= FirebaseDatabase.getInstance().getReference().child("drivers");
    ...
    private  void startRegister(){
        gps=new GPSTracker(SignUpDriver.this);
...
//        final double lon=78.4401;
        ...
        if(!TextUtils.isEmpty(nameval)&& !TextUtils.isEmpty(contactnoval) && !TextUtils.isEmpty(passval) && !TextUtils.isEmpty(conpassval) && !TextUtils.isEmpty(busnoval)){
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    ...
                    if(task.isSuccessful()){
                       ...
                       // currentUser.child("Email").setValue(emailval);
                        ...
                        Intent intent2=new Intent(SignUpDriver.this,SignInDriver.class);
