...
//        final double lon=78.4401;
         ...
         if(!TextUtils.isEmpty(nameval)&& !TextUtils.isEmpty(emailval) && !TextUtils.isEmpty(passval) && !TextUtils.isEmpty(conpassval)){


             mProgess.setMessage("Signing Up...");
             mProgess.show();

             mfireAuth.createUserWithEmailAndPassword(emailval,passval).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                 @Override
